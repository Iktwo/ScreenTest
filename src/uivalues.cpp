...
#ifdef Q_OS_ANDROID
    m_isTablet = QAndroidJniObject::callStaticMethod<jboolean>("com/iktwo/screentest/ScreenTest",
                                                               "isTablet", "()Z");
#endif
}
...
{
#ifdef Q_OS_ANDROID
    QAndroidJniObject::callStaticMethod<void>("com/iktwo/screentest/ScreenTest",
